...
//     version 1.19.0
//     from Assets/Inputs/MainDrone_Actions.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Inputs/MainDrone_Actions.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @MainDrone_Actions: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    /// </summary>
    public @MainDrone_Actions()
    {
        asset = InputActionAsset.FromJson(@"{
    ""version"": 1,
    ""name"": ""MainDrone_Actions"",
    ""maps"": [
        {
            ""name"": ""Drone"",
            ""id"": ""eac9b4d7-010e-4cbd-8900-3e9e59676987"",
            ""actions"": [
                {
                    ""name"": ""Movement"",
                    ""type"": ""Value"",
                    ""id"": ""2fa73bfc-0996-4967-b55e-e31e55a719a3"",
                ...
                },
                {
                    ...
                    ""type"": ""Button"",
                    ""id"": ""c60003bf-abd3-4b8e-8631-8c9f0b7ea118"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                ...
                {
                    ""name"": ""Interact_Bridge"",
                    ""type"": ""Button"",
                    ""id"": ""10edd382-2a0a-4b73-9fc2-001ef25aeb55"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""Next_Text"",
                    ""type"": ""Button"",
                    ""id"": ""dee46481-1d7c-46d3-9657-c6f2af0b54f3"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": ""2D Vector"",
                    ""id"": ""1386323a-5292-43b5-9e6d-3ceb4751b3b5"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""7e8abf05-2ac9-4ccd-8b73-1112fb3050ca"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""45efd468-224d-4443-be62-f42a742082ad"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""83086d5d-f629-4fc5-b7cb-c8e89aac69e3"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""598c554e-2752-4829-81d9-bcfb4408165d"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""6b9a5b6a-cccf-4d2c-bf13-5c6d91053edc"",
                    ""path"": ""<Keyboard>/p"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                    ""action"": ""Interact_Button"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                },
                {
                    ...
                    ""processors"": """",
                    ""groups"": """",
                    ""action"": ""Interact_Bridge"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                },
                {
                    ""name"": """",
                    ""id"": ""cc447dca-e418-4403-9aea-405f2daae9a7"",
                    ""path"": ""<Keyboard>/enter"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ~@MainDrone_Actions()
    {
        UnityEngine.Debug.Assert(!m_Drone.enabled, "This will cause a leak and performance issues, MainDrone_Actions.Drone.Disable() has not been called.");
    }
    ...
    {
        private @MainDrone_Actions m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public DroneActions(@MainDrone_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Drone/Movement".
        /// </summary>
        public InputAction @Movement => m_Wrapper.m_Drone_Movement;
        /// <summary>
        /// Provides access to the underlying input action "Drone/Interact_Button".
        /// </summary>
        public InputAction @Interact_Button => m_Wrapper.m_Drone_Interact_Button;
        /// <summary>
        /// Provides access to the underlying input action "Drone/Interact_Bridge".
        /// </summary>
        public InputAction @Interact_Bridge => m_Wrapper.m_Drone_Interact_Bridge;
        /// <summary>
        ...
        public void AddCallbacks(IDroneActions instance)
        {
            ...
            @Interact_Button.started += instance.OnInteract_Button;
            @Interact_Button.performed += instance.OnInteract_Button;
            @Interact_Button.canceled += instance.OnInteract_Button;
            @Interact_Bridge.started += instance.OnInteract_Bridge;
            @Interact_Bridge.performed += instance.OnInteract_Bridge;
            @Interact_Bridge.canceled += instance.OnInteract_Bridge;
    ...
    public interface IDroneActions
    {
        ...
        /// <summary>
        /// Method invoked when associated input action "Interact_Button" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        void OnInteract_Button(InputAction.CallbackContext context);
        /// <summary>
        /// Method invoked when associated input action "Interact_Bridge" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        void OnInteract_Bridge(InputAction.CallbackContext context);
        /// <summary>
        /// Method invoked when associated input action "Next_Text" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
